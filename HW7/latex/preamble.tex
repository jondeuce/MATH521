...
%% Norms
\newcommand{\Norm}[1]{\ensuremath{||#1||}} % generic norm
\newcommand{\ANorm}[2]{\ensuremath{||#1||_{#2}}} % norm with respect to specified A
\newcommand{\LTwoNorm}[1]{\ensuremath{||#1||_{L^2}}} % L2 norm
\newcommand{\HOneNorm}[1]{\ensuremath{||#1||_{H^1}}} % H1 norm
